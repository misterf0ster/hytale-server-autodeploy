...
```bash
sudo apt update && sudo apt install -y git python3 python3-pip && git clone https://github.com/misterf0ster/hytale-server-autodeploy && cd hytale-server-autodeploy && python3 app.py
```
